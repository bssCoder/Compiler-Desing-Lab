...
void writeStringToFile(const string& filename, const string& content) {
    ...
    if (!file.is_open()) {
        cerr << "Error creating or opening file: " << filename << endl;
        return;
    }
    file << content;
    file.close();
...
//    output cpp file path
    string outputFilename = "C:\\Users\\students\\Desktop\\comment_output.cpp";
	cout << "Given Program \n";
	cout << filename << "\n";
	...
	writeStringToFile(outputFilename, fileContent);
}
